...
function DisputeRow({ booking }: { booking: Booking }) {
  ...
  // Récupérer l'ID du dispute depuis le booking (si disponible)
  // Sinon lien vers la réservation
  const disputeLink = `/sender/bookings/${booking.id}`
      ...
      <div className="p-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center bg-gray-50 rounded-[14px]">
          ...
          <Link to="/sender/bookings"
            className="mt-6 inline-flex items-center gap-2 text-sm text-[#1B3A6B] hover:underline">
  ...
  return (
    <div className="p-4 sm:p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-4 p-4 bg-amber-50 border border-amber-200 rounded-[14px] flex items-start gap-3 text-sm text-amber-800">
        ...
        <p>
          Cliquez sur une réservation pour accéder au fil de discussion du litige et communiquer avec le voyageur et l'équipe Safe Move.
        </p>
      </div>
